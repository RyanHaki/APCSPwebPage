...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>The code below makes a table using HTML code and makes 4 columns titled <code>Time</code>, <code>All-time Cases</code>, <code>Recorded Deaths</code>, and <code>Active Cases</code>. It also makes an id for each row under those 4 columns with the id name the same as its column name.</p>
